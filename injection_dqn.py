...
def main(cfg: Config) -> None:
    ...
    for global_step in range(cfg.total_timesteps):
        ...
        if cfg.apply_injection and global_step == cfg.injection_step:
            print("Applying plasticity injection.")
            q_network.do_injection()
            # Must also update target network such that the forward pass calculations are consistent
            target_network.do_injection()
